...
def train_and_predict(model_out,num_epochs):
    print('-'*30)
    ...
    print('-'*30)
    model.load_weights('weights.h5') #load best weights
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        raise ValueError('USAGE: use 2 arguments: model_out, num_epochs!')
    model_out = sys.argv[1]
    num_epochs= int(sys.argv[2])
    train_and_predict(model_out,num_epochs)
